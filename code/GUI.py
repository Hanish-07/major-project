...
label1 = tkinter.Label(mainWindow, text="HEART DISEASE PREDICTION MODEL", font=('Impact', -35), bg='#ff6600')
label1.grid(row=0, column=0, columnspan=6)

label2 = tkinter.Label(mainWindow, text="Enter the details carefully", font=('Impact', -20) , fg='white', bg='#3399ff' )
...
analyseButton = tkinter.Button(mainWindow, text="ANALYZE", font=('Impact', -15), bg = 'red', command=takeInput)
